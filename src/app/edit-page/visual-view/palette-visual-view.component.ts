...
import { Inspector } from 'gojs/extensionsTS/DataInspector';
...
export class VisualViewComponent implements OnInit {
  ...
  "linkDataArray": [
    ...
    init() {
        ...
        // let sip = Inspector.showIfPresent;

        // this.inspector = Inspector('myInspectorDiv', this.myDiagram,
        //     {
        ...
        //     });
          ...
          let inspector = new Inspector("myInspector", this.myDiagram,
              {
                  includesOwnProperties: false,
                  properties: {
